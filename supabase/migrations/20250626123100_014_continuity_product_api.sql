...
begin
  ...
  set
    schedule_type = case
      when public.continuity_plans.schedule_type = 'manual_demo' then 'recurring_check_in'
      else public.continuity_plans.schedule_type
    end,
    updated_at = public.continuity_plans.updated_at
...
begin
  ...
  interval_minutes := coalesce((plan_row.schedule_config ->> 'interval_minutes')::integer, 5);
